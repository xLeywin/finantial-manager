...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        User u1 = new User("Caio", "caio232@gmail.com", passwordEncoder.encode("61912345"), UserRole.USER);
        User u2 = new User("Maria", "maria54@gmail.com", passwordEncoder.encode("245675643"), UserRole.USER);
        User u3 = new User("admin1", "admin@admin.com", passwordEncoder.encode("245675643"), UserRole.ADMIN);
        ...
        Income income3 = new Income("Bônus", 500.00, u1, IncomeStatus.SCHEDULED, Category.BONUS,
                randomDate(2022, 2023));
        Income income4 = new Income("Freelance", 1200.00, u2, IncomeStatus.DELAYED, Category.BONUS,
                randomDate(2022, 2023));
        ...
        Expense expense4 = new Expense("Internet", 39.99, u1, ExpenseStatus.PAID, Category.ENTERTAINMENT,
                randomDate(2022, 2023));
